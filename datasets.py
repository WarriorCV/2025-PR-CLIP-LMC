...
def load_data(config):
    ...
    elif data_name in ['cifar10_8n_v']:
        mat = sio.loadmat(os.path.join(main_dir, 'data','cifar10_8n_v.mat'))
        X_list.append(mat['X1'])
        X_list.append(mat['X2'])
        X_list.append(mat['X3'])
        Y_list.append(np.squeeze(mat['Y']))

    elif data_name in ['cifar10_4n_v']:
        mat = sio.loadmat(os.path.join(main_dir, 'data','cifar10_4n_v.mat'))
        X_list.append(mat['X1'])
        X_list.append(mat['X2'])
        X_list.append(mat['X3'])
        Y_list.append(np.squeeze(mat['Y']))
    ...
    elif data_name in ['imagenet4n_v']:
        mat = sio.loadmat(os.path.join(main_dir, 'data','imagenet4n_v.mat'))
        X_list.append(mat['X1'])
        X_list.append(mat['X2'])
        X_list.append(mat['X3'])
        Y_list.append(np.squeeze(mat['Y']))
    ...
    elif data_name in ['oxford_4n_x']:
        mat = sio.loadmat(os.path.join(main_dir, 'data','oxford_4n_x.mat'))
        X_list.append(mat['X1'])
        X_list.append(mat['X2'])
        X_list.append(mat['X3'])
        Y_list.append(np.squeeze(mat['Y']))
